...
<body class="bg-grey-100 font-sans antialiased">
    ...
    <div class="">
            ...
            <div class="lg:mx-44 block md:flex">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <a href="https://www.esquel.org.ec/" class="mx-4 lg:w-auto w-full">
                            <img class=" h-12" alt="logo esquel" src="https://www.esquel.org.ec/templates/g5_hydrogen/custom/images/Logo%20Esquel%20Horizontal.svg">
                        </a>    
                        <a href="https://esquelclic.org/" class="mx-4 lg:w-auto w-full">
                            <img class=" h-12" alt="esquel clic" src="https://esquelclic.org/images/logos/LogoCLIC%20.svg">
                        </a>     
                    </div>    
                </div>    
                ...
                <div class="flex">
                    ...
                    <div class="text-sm px-5 my-auto flex">
                        ...
                        <a href="{{ route('CursoAprobado.show', auth()->user()->id) }}">Certificados</a>
                    </div>    
        ...
        <!--======= footer =========-->
        <footer class="bg-gray-800 dark:bg-gray-800 h-full fixed mt-m2_1 sm:mt-m2 md:mt-m3 lg:mt-m5 xl:mt-m5 2xl:mt-m6 w-full">
